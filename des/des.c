...
#else
void DesEncrypt8(const DES_key_schedule* schedule, const unsigned char *plaintext, unsigned char *ciphertext)
{
    DES_ecb_encrypt((DES_cblock*)plaintext, (DES_cblock*)ciphertext, schedule, DES_ENCRYPT);
}

void DesDecrypt8(const DES_key_schedule* schedule, const unsigned char *ciphertext, unsigned char *plaintext)
{
    DES_ecb_encrypt((DES_cblock*)ciphertext, (DES_cblock*)plaintext, schedule, DES_DECRYPT);
}

void DesEncrypt16(const DES_key_schedule* schedule, const unsigned char *plaintext, unsigned char *ciphertext)
{
    DES_ecb_encrypt((DES_cblock*)plaintext, (DES_cblock*)ciphertext, schedule, DES_ENCRYPT);
    DES_ecb_encrypt((DES_cblock*)(plaintext+8), (DES_cblock*)(ciphertext+8), schedule, DES_ENCRYPT);
}

void DesDecrypt16(const DES_key_schedule* schedule, const unsigned char *ciphertext, unsigned char *plaintext)
{
    DES_ecb_encrypt((DES_cblock*)ciphertext, (DES_cblock*)plaintext, schedule, DES_DECRYPT);
    DES_ecb_encrypt((DES_cblock*)(ciphertext+8), (DES_cblock*)(plaintext+8), schedule, DES_DECRYPT);
}
